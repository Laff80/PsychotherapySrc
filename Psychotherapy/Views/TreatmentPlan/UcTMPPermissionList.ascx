<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IPagedList<Insourcia.Psychotherapy.Model.UserTreatmentPlanPermission>>" %>
...
<div style=" margin-left:11px">
      <%=Html.AjaxPager(Model, "GetFormPermissionList", "TreatmentPlan", new PagerOptions { PageIndexParameterName = "id" }, new AjaxOptions { UpdateTargetId = "pagedData_box" })%>
</div>
