<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ManagerSite.Master"
    Inherits="System.Web.Mvc.ViewPage<Insourcia.Psychotherapy.Model.Form>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="table-form-style">
        ...
        <tr>
            ...
            <td>
                <%: Html.DropDownList("category", ViewData["slCategories"] as IEnumerable<SelectListItem>, Model.Categories != null ? Model.Categories.FirstOrDefault().Name : "Please choose the category", new { @class = "selectlist-style" })%>
            </td>
        </tr>
        <tr>
            <th>
